...
Mes principaux points d'intérêt :
- l'algorithmie : [CodinGame](https://www.codingame.com/profile/e0b93d7a66709a1f5641c455a0c225221602724) — 1978ᵉ sur 1,09 M de joueurs classés, l'essentiel des points en arènes de bots multijoueurs et en optimisation.
- la robotique: [Robotique CIV](https://ftc-civ.gitlab.io/index.html) en tant que président et mentor, je m'occupe depuis 2019 du club de robotique du lycée international de Valbonne, avec lequel nous participons aux compétitions internationales de robotique organisées par FIRST.

**Ce que j'ai aussi utilisé :** SQL · Docker & Compose · HTML/CSS/Javascript · Linux · Git
...
| **[Fly-in](https://github.com/JeromeBarthelemy/Fly-in)** | Routage d'une flotte de drones sur graphe contraint : flot de coût minimal sur un graphe étendu dans le temps, capacités de zone appliquées tour par tour. Nombre de tours prouvé optimal par un oracle indépendant, rejeu dans un visualiseur pygame. | Python, pygame |
